...
<body>
  ...
  <td><b>관리작업중...</b>   <input type="submit" value="로그아웃"></td>
   ...
   <table style="border: solid 1px; padding:20; margin:0 auto; text-align:center;">
     <tr><td align="center" bgcolor="gold">상품관련 작업</td></tr>
     <tr><td>
     <a href='productProcess/bookRegisterForm.jsp'>상품등록</a></td></tr>
     <tr><td>
     <a href='productProcess/bookList.jsp?book_kind=all'>상품수정/삭제</a>
     </td></tr>
     <tr><td align="center" bgcolor="gold">구매된 상품관련 작업</td></tr>
