...
<%
 ...
 <ul class="list-group list-group-horizontal-sm">
    <li class="list-group-item list-group-item-action list-group-item-warning"><a href="../shopping/list.jsp?book_kind=all">전체목록</a>&nbsp;
    <li class="list-group-item list-group-item-action list-group-item-warning"><a href="../shopping/cartList.jsp?book_kind=all">장바구니</a>&nbsp;
    <li class="list-group-item list-group-item-action list-group-item-warning"><a href="../shopping/buyList.jsp">구매목록</a>&nbsp;
  </ul>
